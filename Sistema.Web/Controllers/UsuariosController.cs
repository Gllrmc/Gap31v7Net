...
namespace Sistema.Web.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        // GET: api/Usuarios/SelectUsuario
        [Authorize(Roles = "Administrador,JefeAdministracion,AsistAdministracion,ExecutiveProducer,AsistProduccion,LineProducer,ChiefProducer,AsistGeneral")]
        [HttpGet("[action]")]
        public async Task<IEnumerable<UsuarioSelectModel>> SelectUsuario()
        {
            var usuario = await _context.Usuarios.Where(r => r.condicion == true).OrderBy(a => a.userid).ToListAsync();

            return usuario.Select(r => new UsuarioSelectModel
            {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            var activerol = await _context.Roles
                .FirstOrDefaultAsync(u => u.idrol == rolId);

            if (activerol.condicion == false)
            {
                return BadRequest();
            }
